# IDE Expert Agents — Copilot instructions
...
Never leave these docs stale — a PR that adds/removes/updates an agent but doesn't touch both READMEs is incomplete. If unsure whether a change is significant enough to warrant a description update, err on the side of updating it.
