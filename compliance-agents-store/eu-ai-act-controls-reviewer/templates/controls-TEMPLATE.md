...
|---|---|---|---|---|---|---|---|
| 1 | <Requirement — what good looks like> | <Art n> | <A.n> | <FUNCTION n> | <Critical/High/Medium/Low> | <Automatable/Partial/Manual> | <For Automatable/Partial: artifact to inspect. For Manual: why a human is needed> |
