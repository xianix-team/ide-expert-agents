...
- **Essential Intellectual Standards** — the 9 quality tests (clarity, accuracy, precision, relevance, depth, breadth, logic, significance, fairness) applied to each element above, to find precisely where the reasoning is weak, unsupported, or one-sided.
...
If this pass surfaces something missed, revise S2/S3 before moving on rather than noting it and continuing — this step exists to send you backward when it needs to.
